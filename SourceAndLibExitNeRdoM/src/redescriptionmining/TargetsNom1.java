...
public class TargetsNom1 {
     ...
     public static void main(String[] args) {
       ...
       while((line=reader.readLine())!=null){
         ...
         readerReds.inputFile=new File("F:\\Matej Dokumenti\\Redescription mining with CLUS\\Experimenti metali\\redescriptionsMetalsPlazmaAssociationsConstrainedEsencijalniAD1.rr");
       // readerReds.inputFile=new File("C:\\Users\\matej\\Documents\\Redescription mining with CLUS\\redescriptionsGuidedExperimentalIterativeTSMJsupp100-300CITD=14NT=60NI=20.rr");
        //readerReds.inputFile=new File("C:\\Users\\matej\\Documents\\Redescription mining with CLUS\\redescriptionsMetalsLikvorAssociationsADStLev_0 minjs 0.5 JSType 0.rr");
        //readerReds.inputFile=new File("F:\\Matej Dokumenti\\Redescription mining with CLUS\\Experimenti metali\\redescriptionsMetalsPlazmaAssociationsMWADStLev_0 minjs 0.5 JSType 0_10000_30000.rr");
       //readerReds.inputFile=new File("F:\\Matej Dokumenti\\Redescription mining with CLUS\\Experimenti metali\\redescriptionsMetalsPlazmaAssociationsADStLev_0 minjs 0.5 JSType 0.rr");
          // readerReds.inputFile=new File("F:\\Matej Dokumenti\\Redescription mining with CLUS\\Experimenti metali\\redescriptionsMetalsLikvorAssociationsADStLev_0 minjs 0.5 JSType 0.rr");
        ...
        for(int i=0;i<readerReds.set.redescriptions.size();i++){
            ...
            while(it.hasNext()){
                int el=it.next();
                String Selem=map.idExample.get(el);
        ...
        try{
            File output=new File("F:\\Matej Dokumenti\\Redescription mining with CLUS\\Experimenti metali\\redescriptionsMetalsPlazmaAssociationsConstrainedEsencijalniAD1Dist.rr");
           // File output=new File("F:\\Matej Dokumenti\\Redescription mining with CLUS\\Experimenti metali\\redescriptionsMetalsPlazmaAssociationsMWADStLev_0 minjs 0.5 JSType 0_10000_30000AllDist.rr");
            // File output=new File("F:\\Matej Dokumenti\\Redescription mining with CLUS\\Experimenti metali\\redescriptionsMetalsPlazmaAssociationsADStLev_0 minjs 0.5 JSType 0AllDist.rr");
             //File output=new File("F:\\Matej Dokumenti\\Redescription mining with CLUS\\Experimenti metali\\redescriptionsMetalsLikvorAssociationsADStLev_0 minjs 0.5 JSType 0AllDist.rr");
         //redescriptionsMetalsPlazmaAssociationsMWADStLev_0 minjs 0.5 JSType 0_10000_30000
